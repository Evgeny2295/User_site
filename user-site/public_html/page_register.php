                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 ml-auto mr-auto">
                                <div class="card p-4 rounded-plus bg-faded">
                                    ...
                                    <form id="js-login" novalidate="" method="post" action="page_register.php">
                                        <div class="form-group">
                                            <label class="form-label" for="emailverify">Email</label>
                                            <input value="<?=$email?>" name="email" type="email" id="emailverify" class="form-control" placeholder="Эл. адрес" required>
                                        ...
                                        <div class="row no-gutters">
                                            <div class="col-md-4 ml-auto text-right">
                                                <button name="registr" id="js-login-btn" type="submit" class="btn btn-block btn-danger btn-lg mt-3">Регистрация</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
